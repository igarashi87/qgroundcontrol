...
Item {
    ...
    readonly property string droneIsHereTitle:              qsTr("DroneIsHere")  // added by IG to run "Drone is here"
    ...
    readonly property string droneIsHereMessage:                qsTr("Drone is here.")   // added by IG to run "Drone is here"
    ...
    readonly property int actionDroneIsHere:                27   // added by IG to run "set EKF origin"
    ...
    property bool showDroneIsHere:      true // added by IG to run "Drone is here"
    ...
    function confirmAction(actionCode, actionData, mapIndicator) {
        ...
        case actionSetEkfOrigin: // added by IG to run "set EKF origin"
            ...
            confirmDialog.hideTrigger = true
            break
        case actionDroneIsHere: // added by IG to run "set EKF origin"
