...
Item {
    ...
    readonly property string droneDirectionTitle:           qsTr("Drone Direction")
    ...
    readonly property string droneDirectionMessage:             qsTr("Drone Direction.")
    ...
    readonly property int actionDroneDirection:             28
    ...
    property bool showDroneDirection:   true
    ...
    function confirmAction(actionCode, actionData, mapIndicator) {
        ...
        case actionDroneIsHere:
            ...
            confirmDialog.hideTrigger = true
            break
        case actionDroneDirection:
            confirmDialog.title = droneDirectionTitle
            confirmDialog.message = droneDirectionMessage
            confirmDialog.hideTrigger = true
            break
        default:
    ...
    function executeAction(actionCode, actionData, sliderOutputValue, optionChecked) {
        ...
        case actionDroneIsHere:
            ...
            break
        case actionDroneDirection:
            _activeVehicle.droneDirection(actionData)
            break
        default:
